...
---
我的名字是修坤皓，目前是河北工业大学机械工程专业的博士研究生。

目前我的主要研究聚焦在以下方向：利用可穿戴传感器进行人体运动捕捉、识别和分析。具体包括**基于可穿戴传感器的运动识别与重建算法（利用IMUs/应变/压力）**、**基于深度学习的多模态数据融合算法**，以及**高性能柔性应变传感器与压力传感器的制备**。

我致力于将这些技术应用于医疗康复、运动监测等健康领域，实现更智能、更人性化的人机交互。如果您对该方向感兴趣或具备相关专业知识，非常期待与您交流探讨，欢迎通过电子邮件与我联系。

I am Xiu Kunhao, a doctoral student in Mechanical Engineering at Hebei University of Technology.
